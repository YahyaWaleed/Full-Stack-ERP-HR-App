...
public class ReportRepositoryImpl implements ReportRepository {
    ...
    @Override
    public List<Tuple> getEmployeeDirectory() {
    ...
    @Override
    public List<Tuple> getHeadcountByDept() {
        return entityManager.createNativeQuery("""
                SELECT code, department, branch, headcount, males, females,
                       avg_service_years, avg_basic_salary
                FROM v_headcount_by_dept ORDER BY headcount DESC
                """, Tuple.class)
                .getResultList();
    }

    @Override
    public List<Tuple> getPayrollRegister(String periodCode) {
        return entityManager.createNativeQuery("""
    ...
    @Override
    public List<Tuple> getPayrollCostByDept(String periodCode) {
        return entityManager.createNativeQuery("""
    ...
    @Override
    public List<Tuple> getPayrollTrend() {
        return entityManager.createNativeQuery("""
    ...
    @Override
    public List<Tuple> getTaxInsuranceLiability() {
        return entityManager.createNativeQuery("""
    ...
    @Override
    public List<Tuple> getBankTransfer(String periodCode) {
        return entityManager.createNativeQuery("""
    ...
    @Override
    public List<Tuple> getLeaveBalances(int fiscalYear) {
        return entityManager.createNativeQuery("""
    ...
    @Override
    public List<Tuple> getLeaveRequestLog(String status) {
        return entityManager.createNativeQuery("""
    ...
    @Override
    public List<Tuple> getOvertimeTop10() {
        return entityManager.createNativeQuery("""
                ...
                GROUP BY e.emp_code, e.full_name_ar ORDER BY ot_paid DESC LIMIT 10
                """, Tuple.class)
                .getResultList();
    }

    @Override
    public List<Tuple> getAbsenceWatchlist() {
        return entityManager.createNativeQuery("""
    ...
    @Override
    public List<Tuple> getActiveLoans() {
        return entityManager.createNativeQuery("""
                ...
                FROM v_active_loans WHERE status = 'ACTIVE' ORDER BY remaining_balance DESC
                """, Tuple.class)
                .getResultList();
    }

    @Override
    public List<Tuple> getContractsExpiring(int months) {
        return entityManager.createNativeQuery("""
                SELECT e.emp_code, e.full_name_ar, c.contract_no, c.contract_type, c.start_date,
    ...
    @Override
    public List<Tuple> getTopAttendance(String periodCode) {
        return entityManager.createNativeQuery("""
    ...
    @Override
    public List<Tuple> getTopNetSalary(String periodCode) {
        return entityManager.createNativeQuery("""
